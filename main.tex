...
% Read the theme and its logos straight from this repository's folders,
% so the presentation compiles without installing the theme first
\makeatletter
...
\begin{closingframe}
    ...
    \begin{minipage}{.3\textwidth}
        \begin{itemize}
            ...
            \item \hfill\includegraphics[height=.3\textheight]{example-minimal/qr_code.png}
        \end{itemize}
    \end{minipage}%
\end{closingframe}
